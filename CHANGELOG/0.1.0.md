...
```sh
uv add personal_ai_system
```

### What's in the scaffold

- `src/personal_ai_system/` package with CLI (Typer + Rich), py.typed marker
...
[@Natasha3101](https://github.com/Natasha3101) (Natasha Saldanha) created Personal AI System.
